-- Create EMPLOYEE table for the fields employee_id, first_name, last_name, job_title and manager_id as given in employee_index.csv --
...
-- Insert the data into the EMPLOYEE table as per employee_index.csv --
